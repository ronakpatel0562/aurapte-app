...
export default async function SpecialisedTipsPage() {
  ...
  if (!isPremium) {
    // Render Locked Screen for Plan 1
    return (
      <div className="py-8 max-w-2xl mx-auto text-center space-y-8 select-none">
        ...
        <div className="space-y-3">
          ...
          <p className="text-body-sm text-mute leading-relaxed max-w-lg mx-auto">
        ...
        <div className="pt-4 flex flex-col sm:flex-row justify-center gap-4">
          <Link
            href="/dashboard"
            className="h-10 px-6 border border-hairline hover:bg-canvas-soft-2 font-medium text-sm rounded-md transition duration-150 flex items-center justify-center cursor-pointer active:scale-[0.99] text-ink font-semibold"
          >
            Return to Dashboard
          </Link>
          <button className="h-10 px-6 bg-gradient-to-r from-gradient-develop-start to-gradient-preview-start text-white hover:opacity-95 font-medium text-sm rounded-md shadow-md transition duration-150 flex items-center justify-center gap-2 cursor-pointer active:scale-[0.99]">
            <Sparkles className="w-4.5 h-4.5" />
            <span>Upgrade to Premium (Plan 2)</span>
          </button>
        </div>
      </div>
    );
  ...
  // Render Unlocked Screen for Plan 2
  return (
    <div className="space-y-8 py-2 select-none">
      ...
      <div className="space-y-2">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-display-md tracking-tight font-semibold text-ink flex items-center gap-2">
              Specialised Tips & Templates
            </h1>
            <p className="text-body-sm text-mute mt-1">
              Premium expert strategies and high-scoring templates for PTE Academic.
            </p>
          </div>
          ...
          <a
            ...
            className="h-10 px-5 bg-gradient-to-r from-gradient-develop-start to-gradient-preview-start text-white hover:opacity-95 font-medium text-sm rounded-md shadow-md transition duration-150 flex items-center justify-center gap-2 cursor-pointer active:scale-[0.99]"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
        {[
          ...
          <div key={idx} className="bg-canvas border border-hairline rounded-xl p-6 shadow-vercel-card space-y-4">
            <div className="flex items-center justify-between border-b border-hairline pb-3">
              <span className="text-3xs font-mono font-bold text-success uppercase bg-success/5 border border-success/10 px-2 py-0.5 rounded-full">
                {item.module}
              </span>
            ...
            <div className="bg-canvas-soft-2 p-3 rounded-lg border border-hairline text-2xs font-geist text-mute leading-normal">
              {item.tip}
            </div>
          </div>
        ))}
