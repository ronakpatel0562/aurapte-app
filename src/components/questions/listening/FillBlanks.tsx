...
export default function FillBlanks({
  ...
  const hasAnyAnswer = Object.values(userAnswers).some((val) => val.trim() !== "");
              ...
              {parts.map((part, index) => {
                ...
                if (match) {
                  ...
                  const getInputStyles = () => {
                    ...
                    return typedVal
                      ? "border-gray-400 bg-gray-50 text-gray-800 font-medium"
        ...
        <div className="bg-[#b4b7bd]/80 border-t border-gray-300 p-4 flex justify-end items-center select-none rounded-b-lg">
          {!submitted ? (
            <button
              ...
              disabled={isSubmitting || !hasAnyAnswer || audioStatus !== "Audio Finished"}
