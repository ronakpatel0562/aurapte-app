...
export default function RespondingToSituation({
  ...
  const handleSubmit = () => {
    onSubmitAttempt(0, 0, { recorded: true, scenario: content.scenario });
    setPhase("submitted");
  };
  ...
  const statusText =
    phase === "thinking"
      ? `Think time: ${thinkCount} seconds remaining`
      : phase === "recording"
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[#FAF9F6] border border-gray-300 rounded-lg shadow-sm overflow-hidden font-sans">
        ...
        <div className="px-8 pt-6 pb-4 bg-white">
          <div className="border border-gray-200 rounded-lg p-5 bg-white">
            <p className="text-[14px] leading-relaxed" style={{ color: "#2980b9" }}>
              {content.scenario ?? "No scenario provided."}
            </p>
            {content.question && (
              <p className="text-[14px] leading-relaxed mt-2" style={{ color: "#2980b9" }}>
                {content.question}
              </p>
            )}
          </div>
        ...
        {/* Audio box / countdown */}
        <div className="flex justify-center items-center py-8 bg-white select-none">
          {phase === "audio" ? (
            <div
        ...
        <div className="bg-[#b4b7bd]/80 border-t border-gray-300 p-4 flex justify-between items-center select-none rounded-b-lg">
          ...
          {(phase === "audio" || phase === "thinking" || phase === "recording") && (
      ...
      <ComingSoonBanner message="Microphone capture is mock-simulated. Voice analysis and situational response scoring are coming soon in Phase 2." />
    </div>
  );
}
